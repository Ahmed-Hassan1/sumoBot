...
def FirstBot(request):
    ...
    newTarget=msgJson['New Target']

    newEntry2=msgJson['New Entry 2']
    newTarget2=msgJson['New Target 2']

    newEntry3=msgJson['New Entry 3']
    newTarget3=msgJson['New Target 3']

    newEntry4=msgJson['New Entry 4']
    newTarget4=msgJson['New Target 4']
        ...
        if openTrades==0:
            ...
            if balance>=100:
                ...
                try:
                    ...
                    data=client.futures_create_order(symbol=symbol, type=Client.FUTURE_ORDER_TYPE_LIMIT, side=Client.SIDE_SELL, quantity=quantity,price=entries.target,limitprice=entries.target,timeinforce=Client.TIME_IN_FORCE_GTC)
