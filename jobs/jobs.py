            ...
            if openTrades>0:
                ...
                if entries.activateNewEntry==False:
                    ...
                    if info['status']=='FILLED':
                        ...
                        data=client.futures_create_order(symbol=symbol, type=Client.FUTURE_ORDER_TYPE_LIMIT, side=Client.SIDE_SELL, quantity=qty,price=entries.newTarget2,timeinforce=Client.TIME_IN_FORCE_GTC)
                        print(data)
                    ...
                    if info['status']=='FILLED':
                        ...
                        data=client.futures_create_order(symbol=symbol, type=Client.FUTURE_ORDER_TYPE_LIMIT, side=Client.SIDE_SELL, quantity=qty,price=entries.newTarget3,timeinforce=Client.TIME_IN_FORCE_GTC)
                        print(data)
                    ...
                    if info['status']=='FILLED':
                        ...
                        data=client.futures_create_order(symbol=symbol, type=Client.FUTURE_ORDER_TYPE_LIMIT, side=Client.SIDE_SELL, quantity=qty,price=entries.newTarget4,timeinforce=Client.TIME_IN_FORCE_GTC)
                        print(data)
